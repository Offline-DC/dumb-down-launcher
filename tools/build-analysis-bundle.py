...
LLM-friendly bundle described in battery_analysis/battery-diagnostics-plan.md §6:
...
`battery_analysis/battery-diagnostics-plan.md` for the schema described below.
